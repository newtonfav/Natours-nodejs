...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var temp = [lat, lng];
    L.marker(temp).bindPopup("<p style=\"font-size:10px;\">Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
      autoClose: false
    }).addTo(map).openPopup();
    coords.push(temp);
  });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error loging out, Try again later!');
        case 10:
        case "end":
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51LBy0TKGMhE0key35d3w1zAN1wXNgMLLkBxOiEAINKiNBW2t2gCre02n3ZbCIJZhaQnXlyEL2zr5GZegrWt7hrnS00MagD0m3t');
          _context.prev = 1;
          _context.next = 4;
